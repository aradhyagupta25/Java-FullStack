package com.aradhya09.spring_boot_rest.repo;
...
@Repository
public class JopRepo {

    // arraylist to store JobPost objects
    List<JobPost> jobs = new ArrayList<>();

    // constructor injection objects into arraylist above.
    public JopRepo() {
        ...
        jobs.add(new JobPost(4, "Network Engineer",
                "Design and implement computer networks for efficient data communication", 5, List.of("Networking", "Cisco", "Routing", "Switching")));
    ...
    // method to add a job
    public void addJobPosts(JobPost job) {
        jobs.add(job);
    }
}
